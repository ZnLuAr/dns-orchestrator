...
import { TTL_OPTIONS, RECORD_TYPE_INFO } from "@/types/dns";
import {
  Dialog,
  DialogContent,
  DialogHeader,
  ...
  return (
    <Dialog open onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>
            {isEditing ? t("dns.editRecord") : t("dns.addRecord")}
          </DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select
              value={formData.type}
              onValueChange={(v) =>
                setFormData({ ...formData, type: v as DnsRecordType })
              }
              disabled={isEditing}
            >
              <SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(v) =>
                setFormData({ ...formData, ttl: parseInt(v) })
              }
            >
              <SelectTrigger>
                <SelectValue />
